...
# # ugly hack with paths to export __version__ directly from nesoi
...
setup(
    ...
    url='http://mrzv.org/software/nesoi',
    description='Clustering library',
    license='BSD',
    # long_description=long_description,
    ext_modules=[CMakeExtension('nesoi')],
    packages=['nesoi'],
    package_dir = { 'nesoi' : 'bindings/python/nesoi' },
